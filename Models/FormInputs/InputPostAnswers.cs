...
{
    public class InputPostAnswers : InputBase
    {
        public InputPostAnswers()
        {}

        public InputPostAnswers(NewApplicantOutput inNewApplOut)
        {
        ...
        public InputPostAnswers PrepareAnsweredQuestions()
        {
            InputPostAnswers retObj = new InputPostAnswers();
